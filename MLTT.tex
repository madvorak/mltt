...
MLTT rule:
$$\inferrule
{\Gamma,\, n\!\.:\!\.\N \d P(n) \type \\ \Gamma \d p_0 : P(0_\N) \\ \Gamma \d p_S : \Pi_{(n:\N)} \left( P(n) \r P(\s_\N(n)) \right) }
...
MLTT rule:
$$\inferrule
{\Gamma \d A \type \\ \Gamma \d B \type \\ \Gamma,\, z\!\.:\!\.A\!+\!B \d P(z) \type \\ \Gamma \d f : \Pi_{(x:A)} P(\inl(x)) \\ \Gamma \d g : \Pi_{(y:B)} P(\inr(y)) \\ \Gamma \d a\.\!:\!A}
{\Gamma \d\, \ind_+(f, g, \inl(a)) \,\equiv\, f(a) : P(\inl(a))}
\smallskip
$$
MLTT rule?
$$\inferrule
{\Gamma \d A \type \\ \Gamma \d B \type \\ \Gamma,\, z\!\.:\!\.A\!+\!B \d P(z) \type \\ \Gamma \d f : \Pi_{(x:A)} P(\inl(x)) \\ \Gamma \d g : \Pi_{(y:B)} P(\inr(y))}
{\Gamma,\, a\!:\!A \d\, \ind_+(f, g, \inl(a)) \,\equiv\, f(a) : P(\inl(a))}
\smallskip
$$
MLTT rule!
$$\inferrule
